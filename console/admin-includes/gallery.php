	...
	<input type="hidden" name="post">
						...
						<div class="panel-body">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-3 mb-15">
                                        <select class="form-control" required name="alignment-<?= $i; ?>">
                                            <option value="" selected disabled>Select Alignment</option>
                                            <option <?php if($gallery_image->alignment == 'centre'){ echo "selected";} ?> value="centre">Centre</option>
                                            <option <?php if($gallery_image->alignment == 'left'){ echo "selected";} ?> value="left">Left</option>
                                            <option <?php if($gallery_image->alignment == 'right'){ echo "selected";} ?> value="right">Right</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mb-15">

                                        <input placeholder="First line..." type="text" class="form-control" id="line-<?= $i ?>" name="line-<?= $i ?>" value="<?php if(isset($gallery_image->line)){ print $gallery_image->line; } ?>">

                                    </div>
                                    <div class="col-md-3 mb-15">

                                        <input placeholder="Second line..." type="text" class="form-control" id="line1-<?= $i ?>" name="line1-<?= $i ?>" value="<?php if(isset($gallery_image->line1)){ print $gallery_image->line1; } ?>">

                                    </div>
                                    <div class="col-md-3 mb-15">

                                        <input placeholder="Third line..." type="text" class="form-control" id="line2-<?= $i ?>" name="line2-<?= $i ?>" value="<?php if(isset($gallery_image->line2)){ print $gallery_image->line2; } ?>">
...
<?php print "<a onclick=\"return confirm('Are you sure you want to delete this image?')\" href='account.php?page=gallery&action=delete-image&image_id=".$gallery_image->id."'><img style='height:50px' src='../gallery-images/".$gallery_image->id.".".$gallery_image->ext."'></a>";  ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-3 mb-15">
                                        <select class="form-control" name="alignment-<?= $i; ?>">
                                            <option value="" selected disabled>Select Alignment</option>
                                    ...
                                    <div class="col-md-3 mb-15">
                                        ...
                                        <input placeholder="First line..." type="text" class="form-control" id="line-<?= $i ?>" name="line-<?= $i ?>">

                                    </div>
                                    <div class="col-md-3 mb-15">

                                        <input placeholder="Second line..." type="text" class="form-control" id="line1-<?= $i ?>" name="line1-<?= $i ?>">

                                    </div>
                                    <div class="col-md-3 mb-15">

                                        <input placeholder="Third line..." type="text" class="form-control" id="line2-<?= $i ?>" name="line2-<?= $i ?>">
