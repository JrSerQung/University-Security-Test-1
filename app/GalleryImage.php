...
class GalleryImage extends ObjectModel
{
    ...
    protected $fillable = ['alt', 'ext','alignment','line','line1','line2','btntext'];
    protected $rules = [];
    ...
    public function addImage($id = null, $alt, $ext,$alignment,$line,$line1,$line2,$btntext)
    {
    ...
    public function updateImage($id,  $alt, $ext,$alignment,$line,$line1,$line2,$btntext)
    {
